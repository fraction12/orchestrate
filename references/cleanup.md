...
2. Classify each unit/lane as `cleanable`, `active`, `parked`, `ambiguous`, or `protected`.
...
7. Archive worker threads:
   - archive only threads recorded as worker lanes or titled `WORKER ...`;
